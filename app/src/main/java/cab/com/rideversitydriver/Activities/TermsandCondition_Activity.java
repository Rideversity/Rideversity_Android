 ...
 */
public class TermsandCondition_Activity extends AppCompatActivity implements View.OnClickListener {

    MyApplication application = null;
    static TextView txtTermCondition;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutFull = (RelativeLayout) findViewById(R.id.layout_terms_conditions);
        txtTermCondition = (TextView) findViewById(R.id.textView_terms_condition_text);
    ...
    public void TermsandService() {
        CommonAsynTask termsAsyncTask = new CommonAsynTask(context, Constants.TERMS_URL, "",
                ...
                if (jsonObject != null) {
                    try {
                        if (jsonObject.getString(Constants.RESULT).equals(Constants.SUCCESS)) {
                            ...
                            webView.loadData(userObj.getString(Constants.DESCRIPTION), "text/html; charset=utf-8", "UTF-8");
