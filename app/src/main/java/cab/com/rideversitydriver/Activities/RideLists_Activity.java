...
import cab.com.rideversitydriver.Adapters.RideList_Adapter;
 ...
 */
public class RideLists_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addValues();
        adapter = new RideList_Adapter(context);
    ...
    private class RideListOnClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent detailsIntent = new Intent(context, RideDetails_Activity.class);
